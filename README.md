...
echo ""
echo "Updating system and installing Node.js, Nginx, Certbot and UFW..."
apt update
...
# Serve the dist folder generated by build
pm2 start serve --name "ashpazkhoneh" -- -s dist -l $APP_PORT
pm2 save
pm2 startup

# 7. Configure Firewall (Redirect / Security)
echo ""
echo "Configuring Firewall..."
ufw allow OpenSSH
ufw allow 'Nginx Full'
# We intentionally do NOT allow APP_PORT directly to force traffic through Nginx
ufw --force enable
echo "Firewall enabled. Port $APP_PORT blocked externally."
